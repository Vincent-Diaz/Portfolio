            ...
            <Container>
                ...
                <Row>
                    <Col size="lg-3">
                        ...
                        <Link className="link1" href="https://github.com/Vincent-Diaz" target="_blank" rel="noopener noreferrer">
                            Link to Github Profile
                        </Link>
                        <hr />
                        <Link className="link2" href="https://www.linkedin.com/in/vincent-diaz-89a4609b/" target="_blank" rel="noopener noreferrer">
                            Link to Linkedin Profile
                        </Link>
                        <hr />
                        <Link className="link3" href="./Vincent_Diaz_Resume.pdf" target="_blank" rel="noopener noreferrer">
                            Link to Resume
                        </Link>
                    </Col>
                    <Col size="lg-9">
